...
<head>
    <meta charset="UTF-8">
    <title>Vibin - Playlist Management</title>
...
<body class="bg-gray-900 text-white">
    ...
    <div class="container mx-auto py-8 px-4">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-purple-400">Playlist Management</h1>
        </div>
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden mb-6">
            <div class="p-4">
                <form action="admin-playlists.jsp" method="get" class="flex items-center">
                    <input type="text" name="search" placeholder="Search by playlist name or username" 
                ...
                <table class="min-w-full divide-y divide-gray-700">
                    <thead class="bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Playlist Name</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">User</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Created Date</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Songs</th>
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        try {
                            ...
                            String sql = "SELECT p.playlist_id, p.playlist_name, p.created_date, p.description, " +
                            ...
                            if (request.getParameter("search") != null && !request.getParameter("search").isEmpty()) {
                                ...
                                sql += " WHERE p.playlist_name LIKE ? OR u.name LIKE ?";
                        ...
                        <tr class="hover:bg-gray-700">
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getInt("playlist_id") %></td>
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getString("playlist_name") %></td>
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getString("user_name") %></td>
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getTimestamp("created_date") %></td>
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getInt("song_count") %></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="admin-playlist-detail.jsp?id=<%= rs.getInt("playlist_id") %>" class="text-purple-400 hover:text-purple-300 mr-3">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="admin-playlist-delete.jsp?id=<%= rs.getInt("playlist_id") %>" 
