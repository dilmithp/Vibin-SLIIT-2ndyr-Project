...
<%
    ...
    try {
        ...
        // Get artist details
        PreparedStatement artistStmt = conn.prepareStatement("SELECT * FROM artists WHERE artist_id = ?");
        artistStmt.setInt(1, Integer.parseInt(artistId));
        
        ResultSet artistRs = artistStmt.executeQuery();
        if (artistRs.next()) {
            artistName = artistRs.getString("artist_name");
        } else {
            artistRs.close();
            artistStmt.close();
            conn.close();
            response.sendRedirect("admin-artists.jsp?error=Artist not found");
            return;
        }
        artistRs.close();
        artistStmt.close();
...
<body class="bg-gray-900 text-white">
    ...
    <div class="container mx-auto py-8 px-4">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold text-purple-400">Songs by <%= artistName %></h1>
            </div>
            <div class="flex space-x-2">
                <a href="admin-song-form.jsp?artist=<%= artistName %>" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium transition duration-200">
                    <i class="fas fa-plus mr-2"></i>Add Song for Artist
                </a>
                <a href="admin-artists.jsp" class="px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg font-medium transition duration-200">
                ...
                <table class="min-w-full divide-y divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        PreparedStatement songStmt = conn.prepareStatement(
                            "SELECT s.*, a.album_name FROM songs s " +
                        ...
                        <tr class="hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <a href="admin-song-delete.jsp?id=<%= songRs.getInt("song_id") %>&returnTo=artist&artistId=<%= artistId %>" 
                        ...
                        %>
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-400">No songs found for this artist.</td>
                        </tr>
                        <%
                        }
