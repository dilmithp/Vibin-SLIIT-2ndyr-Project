...
<head>
    <meta charset="UTF-8">
    <title>Vibin - Artist Signup</title>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-purple-500">Artist Registration</h1>
                <p class="text-gray-400 mt-2">Join Vibin as an artist</p>
            </div>
            ...
            <form action="<%=request.getContextPath()%>/ArtistSignupServlet" method="post" class="space-y-4">
                <div>
            ...
            <div class="mt-6 text-center">
                ...
                <a href="artist-login.jsp" class="text-purple-400 hover:text-purple-300">
