    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-purple-500">Artist Portal</h1>
                <p class="text-gray-400 mt-2">Login to manage your music</p>
            </div>
            ...
            <form action="<%=request.getContextPath()%>/ArtistLoginServlet" method="post">
                <div class="mb-4">
            ...
            <div class="mt-4 text-center">
	    		<p class="text-gray-400">Don't have an account?</p>
	   			<a href="artist-signup.jsp" class="text-purple-400 hover:text-purple-300">
