...
<head>
    <meta charset="UTF-8">
    <title>Vibin - User Management</title>
...
<body class="bg-gray-900 text-white">
    ...
    <div class="container mx-auto py-8 px-4">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-purple-400">User Management</h1>
            <a href="admin-user-form.jsp" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium transition duration-200">
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden mb-6">
            <div class="p-4">
                <form action="admin-users.jsp" method="get" class="flex items-center">
                ...
                <table class="min-w-full divide-y divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-700">
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getInt("id") %></td>
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getString("name") %></td>
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getString("email") %></td>
                            <td class="px-6 py-4 whitespace-nowrap"><%= rs.getString("contact_no") != null ? rs.getString("contact_no") : "-" %></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="admin-user-form.jsp?id=<%= rs.getInt("id") %>" class="text-blue-400 hover:text-blue-300 mr-3">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="admin-user-delete.jsp?id=<%= rs.getInt("id") %>" 
                                   onclick="return confirm('Are you sure you want to delete this user? This will also delete all their playlists and liked songs.')"
