...
<%
    ...
    String username = (String)session.getAttribute("artistUsername");
    ...
    try {
        ...
        PreparedStatement pstmt = conn.prepareStatement(
            "SELECT a.*, al.email FROM artists a " +
            "LEFT JOIN artist_login al ON a.artist_id = al.artist_id " +
            "WHERE a.artist_id = ?"
        );
    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-black p-6 flex flex-col">
            ...
            <nav class="flex-1 space-y-4">
                ...
                <a href="artist-profile.jsp" class="flex items-center text-purple-400 p-2 rounded-lg bg-gray-800">
